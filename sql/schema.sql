...
begin
  if not exists (
    ...
    create type public.app_role as enum ('admin', 'spotter', 'parent', 'classroom');
  end if;
end
$$;
...
-- Password-gated auth finalization.
alter type public.app_role add value if not exists 'parent';
alter type public.app_role add value if not exists 'classroom';
